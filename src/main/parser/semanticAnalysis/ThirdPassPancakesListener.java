...
public class ThirdPassPancakesListener extends PancakesBaseListener {
    ...
    Symbol.Type[] types = {Symbol.Type.tSTRING, Symbol.Type.tINT, Symbol.Type.tINT, Symbol.Type.tFLOAT};
...
//        }
    ...
    private void addAll(){
        ...
        addToTesseract(Operand.oEquality, Symbol.Type.tSTRING, Symbol.Type.tSTRING, Symbol.Type.tINT);
        ...
        addToTesseract(Operand.oEquality, Symbol.Type.tFLOAT, Symbol.Type.tINT, Symbol.Type.tINVALID);
        addToTesseract(Operand.oEquality, Symbol.Type.tFLOAT, Symbol.Type.tFLOAT, Symbol.Type.tINT);
        ...
        addToTesseract(Operand.oEquality, Symbol.Type.tINT, Symbol.Type.tINT, Symbol.Type.tINT);
        ...
        addToTesseract(Operand.oUnaryNot, Symbol.Type.tINT, Symbol.Type.tINT, Symbol.Type.tINT);
